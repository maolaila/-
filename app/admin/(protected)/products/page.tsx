    ...
    <div className="grid gap-6">
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">管理商品上下架、库存、规格、图片和 SEO。</p>
        </div>
      ...
      <form className="grid gap-3 rounded-md border border-line bg-white p-4 md:grid-cols-[1fr_180px_160px_auto]">
        <input className="h-10 rounded-md border border-line px-3" defaultValue={first(params.q) ?? ""} name="q" placeholder="名称或 SKU" />
